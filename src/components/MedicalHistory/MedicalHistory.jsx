...
<h1 className="text-3xl font-semibold text-blue-900 mb-8 text-center flex items-center justify-center gap-3">
  <HiOutlineClipboardDocument className="text-blue-900 text-4xl" />
  <span className="tracking-wide">Patients </span>
</h1>
          ...
          <table className="w-full text-sm text-gray-800">
            <thead className="bg-blue-600 text-white text-left">
              <tr>
                ...
                <th className="px-6 py-4">بيانات المرضى</th>
              </tr>
            </thead>
            <tbody>
